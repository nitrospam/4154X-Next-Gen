...
void rightHalfWinPoint(){
  ...
  profileController->generatePath(
      {{0_ft, 0_ft, 0_deg}, {1.2_ft, 0_ft, 0_deg}}, "rightAmogoGrab");
  ...
  profileController->generatePath(
      {{0_ft, 0_ft, 0_deg}, {12_ft, 0_ft, 0_deg}}, "rightMatchLoads");
...
void leftHalfWinPoint(){
  ...
  profileController->generatePath(
      {{0_ft, 0_ft, 0_deg}, {1.2_ft, 0_ft, 0_deg}}, "leftAmogoBack");
  //Have the robot follow the path above in reverse
...
void testSkills(){
  ...
  profileController->generatePath(
      {{0_ft, 0_ft, 0_deg}, {0.29_ft, 0_ft, 0_deg}}, "redMogoPlatformBack");
  //Set robot to follow the above path
